...
exports.config = exports.modulate = exports.flattenPreservingPaths = void 0;
...
const exportCleaner = (obj) => Object.entries(obj).reduce((a, c) => {
    ...
    else if ((0, checks_1.isPlainObject)(v)) {
 ...
 */
const flattenPreservingPaths = (obj, provider = 'aws', // FIXME: adds this to everything, even things you may not want
path = [], acc = {}, refs = false) => {
    ...
    return Object.entries(obj).reduce((a, c) => {
        ...
        if (pivotPoints.includes(key)) {
            ...
            return {
                ...a,
                ...(0, exports.flattenPreservingPaths)(val, provider, [...path, key], a, refs),
            };
        }
    }, acc);
};
exports.flattenPreservingPaths = flattenPreservingPaths;
/**
 ...
 */
const modulate = (obj, provider = 'aws') => {
    const [key, fn] = Object.entries(obj)[0];
    const ref = { [key]: fn({}) };
    const refs = (0, exports.flattenPreservingPaths)(ref, provider, [], {}, true);
    return (...args) => {
        const obj = { [key]: fn(...args, refs) };
        const flattened = (0, exports.flattenPreservingPaths)(obj, provider, [], {}, false);
        const out = { ...flattened };
        return out;
    };
};
 ...
 */
const config = (provider, terraform, outputFile) => {
    if (!(0, checks_1.isArray)(provider)) {
        provider = [provider];
    }
    ...
    return (...objs) => {
        ...
        (0, fs_1.writeFileSync)(outputFile, out);
        return merged;
    };
};
