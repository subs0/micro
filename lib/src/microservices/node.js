...
export const Node = ({ name, tags, api, architectures = ['x86_64'], src_path = '${path.root}/src', artifacts_dir = '${path.root}/builds', package_py = '${path.root}/src/utils/package.py', memory_size = 512, env_vars = {}, handler = 'index.handler', runtime = 'python3.11', tmp_storage = 1024, timeout = 60, bucket = true, sns, docker, }) => {
