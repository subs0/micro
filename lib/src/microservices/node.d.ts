...
export declare const Node: ({ name, tags, api, architectures, src_path, artifacts_dir, package_py, memory_size, env_vars, handler, runtime, tmp_storage, timeout, role_arn, s3, sns, docker, }: INode) => any;
export {};
/**
 * TODO
