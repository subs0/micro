...
const bucket_policy_statement = ({ bucket_name, lambda_role_arn = '' }) => ({
...
export const multi_stmt_policy_doc = ({ bucket_name = '', topic_arn = '', cloudwatch_arn = '', lambda_role_arn = '', }) => ({
    data: {
        iam_policy_document: {
            statement: [
                ...(bucket_name
