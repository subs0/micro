 ...
 */
export declare const ecrRepository: ({ name, mutability, force_delete, scan, tags, }: {
    name: any;
 ...
 */
export declare const ecrLifecyclePolicy: ({ policy, repo, }: {
...
export declare const EcrRepo: ({ name, mutability, force_delete, scan, policy, tags, }: EcrRepository, my: {
    [key: string]: AWS;
}) => {
    [key: string]: AWS;
};
