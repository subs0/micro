 ...
 */
export const ecrRepository = ({ name, mutability = 'MUTABLE', force_delete = true, scan = false, tags = {}, }) => ({
    resource: {
 ...
 */
export const ecrLifecyclePolicy = ({ policy = default_lifecycle_policy, repo, }) => ({
    resource: {
...
export const EcrRepo = ({ name, mutability = 'MUTABLE', force_delete = true, scan = false, policy = default_lifecycle_policy, tags = {}, }, my) => {
    return {
