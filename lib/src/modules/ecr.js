 ...
 */
export const ecr_repo = ({ name, mutability = 'MUTABLE', force_delete = true, scan = false, tags = {}, }) => ({
    resource: {
 ...
 */
export const ecr_lifecycle_policy = ({ policy = default_lifecycle_policy, repo, }) => ({
    resource: {
...
export const ecr_repository = ({ name, mutability = 'MUTABLE', force_delete = true, scan = false, policy = default_lifecycle_policy, tags = {}, }, my) => {
    return {
        ecr_repo: ecr_repo({
            name,
            mutability,
