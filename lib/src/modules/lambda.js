...
import { s3BucketPolicy, s3BucketCors, s3bucket, bucketPolicyStatement, s3BucketPolicyDocument, } from './s3';
...
const multiStatementIamPolicyDoc = ({ bucket = '', topic_arn = '', cloudwatch_arn = '', role_arn = '', }) => ({
    data: {
        iam_policy_document: {
            statement: [
