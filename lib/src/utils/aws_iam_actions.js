export const s3 = {
    ...
    's3:DeleteObject': {
        permits: 'remove the null version of an object and insert a delete marker, which becomes the current version of the object',
        resource_type: 'object*',
        access_level: 'Write',
    },
    ...
    's3:GetAccelerateConfiguration': {
        permits: 'uses the accelerate subresource to return the Transfer Acceleration state of a bucket, which is either Enabled or Suspended',
        resource_type: 'bucket*',
        access_level: 'Read',
    },
    's3:GetAccessPoint': {
    ...
    's3:GetAccessPointPolicyForObjectLambda': {
        permits: 'returns the access point policy associated with the specified object lambda enabled access point',
        resource_type: 'objectlambdaaccesspoint*',
        access_level: 'Read',
    },
    ...
    's3:GetAnalyticsConfiguration': {
        permits: 'get an analytics configuration from an Amazon S3 bucket, identified by the analytics configuration ID',
        resource_type: 'bucket*',
        access_level: 'Read',
    },
    's3:GetBucketAcl': {
        permits: 'use the acl subresource to return the access control list (ACL) of an Amazon S3 bucket',
        resource_type: 'bucket*',
        access_level: 'Read',
    },
    's3:GetBucketCORS': {
    ...
    's3:GetBucketLogging': {
        permits: 'return the logging status of an Amazon S3 bucket and the permissions users have to view or modify that status',
        resource_type: 'bucket*',
        access_level: 'Read',
    },
    ...
    's3:GetBucketPolicyStatus': {
        permits: 'retrieve the policy status for a specific Amazon S3 bucket, which indicates whether the bucket is public',
        resource_type: 'bucket*',
        access_level: 'Read',
    },
    ...
    's3:GetInventoryConfiguration': {
        permits: 'return an inventory configuration from an Amazon S3 bucket, identified by the inventory configuration ID',
        resource_type: 'bucket*',
        access_level: 'Read',
    },
    's3:GetJobTagging': {
    ...
    's3:GetMultiRegionAccessPointPolicy': {
        permits: 'returns the access point policy associated with the specified Multi-Region Access Point',
        resource_type: 'multiregionaccesspoint*',
        access_level: 'Read',
    },
    ...
    's3:InitiateReplication': {
        permits: 'initiate the replication process by setting replication status of an object to pending',
        resource_type: 'object*',
        access_level: 'Write',
    },
    's3:ListAccessPoints': {
    ...
    's3:PutAccelerateConfiguration': {
        permits: 'use the accelerate subresource to set the Transfer Acceleration state of an existing S3 bucket',
        resource_type: 'bucket*',
        access_level: 'Write',
    },
    ...
    's3:PutAccessPointPublicAccessBlock': {
        permits: 'associate public access block configurations with a specified access point, while creating a access point',
        resource_type: '',
        access_level: 'Permissions management',
    },
    ...
    's3:PutAnalyticsConfiguration': {
        permits: 'set an analytics configuration for the bucket, specified by the analytics configuration ID',
        resource_type: 'bucket*',
        access_level: 'Write',
    },
    's3:PutBucketAcl': {
    ...
    's3:PutBucketPublicAccessBlock': {
        permits: 'create or modify the PublicAccessBlock configuration for a specific Amazon S3 bucket',
        resource_type: 'bucket*',
        access_level: 'Permissions management',
    },
    ...
    's3:PutIntelligentTieringConfiguration': {
        permits: 'create new or update or delete an existing Amazon S3 Intelligent Tiering configuration',
        resource_type: 'bucket*',
        access_level: 'Write',
    },
    ...
    's3:PutLifecycleConfiguration': {
        permits: 'create a new lifecycle configuration for the bucket or replace an existing lifecycle configuration',
        resource_type: 'bucket*',
        access_level: 'Write',
    },
    's3:PutMetricsConfiguration': {
        permits: 'set or update a metrics configuration for the CloudWatch request metrics from an Amazon S3 bucket',
        resource_type: 'bucket*',
        access_level: 'Write',
    },
    ...
    's3:PutObjectAcl': {
        permits: 'set the access control list (ACL) permissions for new or existing objects in an S3 bucket',
        resource_type: 'object*',
        access_level: 'Permissions management',
    },
    ...
    's3:PutObjectVersionAcl': {
        permits: 'use the acl subresource to set the access control list (ACL) permissions for an object that already exists in a bucket',
        resource_type: 'object*',
        access_level: 'Permissions management',
    },
...
//# sourceMappingURL=aws_iam_actions.js.map