...
export interface Data {
    ...
    servicequotas_templates?: ServicequotasTemplates;
...
export interface ServicequotasTemplates {
    region: string;
    templates?: Templates;
}
...
export interface Resource {
    ...
    ec2_image_block_public_access?: Ec2ImageBlockPublicAccess;
    ...
    guardduty_detector_feature?: GuarddutyDetectorFeature;
    ...
    servicequotas_template_association?: ServicequotasTemplateAssociation;
    ...
    verifiedaccess_instance_logging_configuration?: VerifiedaccessInstanceLoggingConfiguration;
    ...
    sesv2_account_vdm_attributes?: Sesv2AccountVDMAttributes;
    ...
    verifiedaccess_group?: VerifiedaccessGroup;
    ...
    guardduty_organization_configuration_feature?: GuarddutyOrganizationConfigurationFeature;
    ...
    verifiedaccess_instance_trust_provider_attachment?: VerifiedaccessInstanceTrustProviderAttachment;
    ...
    servicequotas_template?: ServicequotasTemplate;
...
export interface S3Settings {
    ...
    glue_catalog_generation?: string;
...
export interface ResourceDynamodbTable {
    attribute: EvaluationRulesClass;
    s3_bucket_source: string;
    range_key: string;
    region_name: string;
    billing_mode?: string;
...
export interface EvaluationRulesClass {
    name?: string;
    type?: string;
}
...
export interface Ec2ImageBlockPublicAccess {
    state: string;
}
...
export interface EvidentlyFeature {
    ...
    arn?: string;
    created_time?: string;
    evaluation_rules?: EvaluationRulesClass;
    id?: string;
    last_updated_time?: string;
    status?: string;
    tags_all?: string;
...
export interface GuarddutyDetectorFeature {
    detector_id: string;
...
export interface GuarddutyOrganizationConfigurationFeature {
    detector_id: string;
...
export interface KinesisFirehoseDeliveryStream {
    ...
    opensearchserverless_configuration?: string;
...
export interface ResourceQuicksightDataSet {
    ...
    input_columns: EvaluationRulesClass;
...
export interface ServicequotasTemplateAssociation {
    skip_destroy?: string;
    id?: string;
    status?: string;
}
...
export interface Sesv2AccountVDMAttributes {
    vdm_enabled: string;
    dashboard_attributes?: Dashboard;
    guardian_attributes?: Guardian;
}
...
export interface VerifiedaccessInstanceTrustProviderAttachment {
    verifiedaccess_instance_id: string;
...
export interface Wafv2RuleGroup {
    ...
    content: string;
    content_type: string;
    action: Wafv2RuleGroupAction;
    priority: string;
    statement: Wafv2RuleGroupStatement;
    insert_header: string;
    response_code: string;
    field_to_match: Wafv2RuleGroupFieldToMatch;
    positional_constraint: string;
    search_string: string;
    ...
    byte_match_statement?: Wafv2RuleGroupByteMatchStatement;
    ...
    regex_pattern_set_reference_statement?: Wafv2RuleGroupRegexPatternSetReferenceStatement;
    size_constraint_statement?: SizeConstraintStatement;
    sqli_match_statement?: string;
    xss_match_statement?: SQLInjectionMatchTuple;
    ...
    id?: string;
    tags_all?: string;
    cookie?: KmsSecretClass;
    forwarded_ip?: KmsSecretClass;
    http_method?: KmsSecretClass;
    header?: KmsSecretClass;
    ip?: KmsSecretClass;
    label_namespace?: KmsSecretClass;
    query_argument?: KmsSecretClass;
}
export interface Wafv2RuleGroupAction {
    allow?: string;
    block?: string;
    captcha?: string;
    challenge?: string;
...
export interface Wafv2WebACL {
    ...
    byte_match_statement?: Wafv2WebACLByteMatchStatement;
    geo_match_statement?: GeoMatchStatement;
    ip_set_reference_statement?: IPSetReferenceStatement;
    label_match_statement?: LabelMatchStatement;
    ...
    rate_based_statement?: RateBasedStatement;
    regex_match_statement?: RegexMatchStatement;
    regex_pattern_set_reference_statement?: Wafv2WebACLRegexPatternSetReferenceStatement;
